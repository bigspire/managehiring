<?php
/* 
Purpose : To get position rejection analysis degree.
Created : Nikitasa
Date : 16-7-2018
*/
...
if(!empty($_POST)){	
	...
	$query = "CALL check_degree_exist('0', '".$fun->is_white_space($_POST['degree'])."','".$_POST['qualification']."')";
...
// assign page title
$smarty->assign('page_title' , 'Position Rejection Analysis - Manage Hiring');  
// assigning active class status to smarty menu.tpl
$smarty->assign('report_menu','active');	  
// display smarty file
$smarty->display('position_rejection_analysis.tpl');
?>