							...
							<table class="table table-bordered dataTable" style="margin-bottom:0;">
								...
								<tr>
									...
									<tr class="tbl_row">
										...
										<input type="checkbox" name="present_work" {if $present_work == '1' || $smarty.post.present_work == '1'}{'checked'}{/if} value="1" style="margin-left:5px;"> <span class="tbl_column">Presently Working?</span>
