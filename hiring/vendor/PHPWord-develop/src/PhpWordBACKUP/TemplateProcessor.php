...
class TemplateProcessor
{
    ...
    public function setValue($search, $replace, $exact_match, $limit = self::MAXIMUM_REPLACEMENTS_DEFAULT)
    {
        if (is_array($search)) {
    ...
    protected function setValueForPart($search, $replace, $documentPartXML, $limit)
    {
		...
		*/
		...
		echo $toOpenXML = HTMLtoOpenXML::getInstance()->fromHTML("<br>ravi<br>ravi<br>ravi<br>ravi");
