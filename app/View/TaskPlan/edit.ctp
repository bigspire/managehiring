...
<?php echo $this->element('header');?>			
	...
	<?php echo $this->Form->create('TaskPlan', array('id' => '', 'class' => 'formID', 'enctype' => 'multipart/form-data')); ?>
...
<?php echo $this->Form->input('TaskPlan.id', array('type' => 'hidden')); ?>

<?php echo $this->Form->input('page', array('type' => 'hidden',  'id' => 'edit_task', 'value' => 'edit_task')); ?>
