                ...
                <div class="main_content">
					...
					<div class="row-fluid">
					  ...
					  <div class="span12" style="margin:0;">
							<h3 class="heading" style="margin-bottom:0;">Recruiter Performance <small> Table View</small>
							</h3>
							...
							<label style="margin-top:18px;"><a href="javascript:void(0)"><input value="Toggle Graph" type="button" class="btn hide_graph"/></a></label>
							
							<label style="margin-top:18px;"><a href="#"><input value="Export" type="button" class="btn btn-warning"/></a></label>
							
							<label style="margin-top:18px;"><a href="#"><input value="Reset" type="button" class="btn"/></a></label>
							...
							<table class="table table-hover table-bordered  stickyTable" style="padding: 0px;">
								<thead class="tableFloatingHeaderOriginal" style="position: static; margin-top: 0px; left: 31px; z-index: 3; width: 1287px; top: 0px;">
									...
									<tr>
										...
										<th width="" style="min-width: 0px; max-width: none;"></th>
										<th width="260" style="text-align:center;min-width: 0px; max-width: none;" colspan="4">CTC wise Positions Worked </th>
										<th width="260" style="text-align:center;min-width: 0px; max-width: none;"  colspan="4">CTC wise Profiles Submitted </th>
										<th width="260" style="text-align:center;min-width: 0px; max-width: none;"  colspan="4">CTC wise Positions Closed </th>
										<th width="180" style="text-align:center;min-width: 0px; max-width: none;" colspan="3">Individual contributions (in Rs.)</th>
										<th width="" style="min-width: 0px; max-width: none;"></th>
										<th width="" style="min-width: 0px; max-width: none;"></th>
									...
									<tr>
										...
										<th width="50" style="min-width: 0px; max-width: none;text-align:center"><a href="#">< 10</a></a></th>
										<th width="75" style="min-width: 0px; max-width: none;text-align:center" ><a href="#">10 - 25</a></th>
										<th width="85" style="min-width: 0px; max-width: none;text-align:center"><a href="#">25 - 40</a> </th>
										<th width="50" style="min-width: 0px; max-width: none;text-align:center"><a href="#">> 40</a> </th>
										
										<th width="50" style="min-width: 0px; max-width: none;text-align:center"><a href="#">< 10</a></th>
										<th width="75" style="min-width: 0px; max-width: none;text-align:center" ><a href="#">10 - 25</a></th>
										<th width="85" style="min-width: 0px; max-width: none;text-align:center"><a href="#">25 - 40</a> </th>
										<th width="50" style="min-width: 0px; max-width: none;text-align:center"><a href="#">> 40</a> </th>
										...
										<th width="60" style="min-width: 0px; max-width: none;"><a href="#">Sourcing</a></th>
										<th width="60" style="min-width: 0px; max-width: none;"><a href="#">Client</a></th>
										<th width="60" style="min-width: 0px; max-width: none;"><a href="#">Candidate</a></th>
										
										<th width="110" style="min-width: 0px; max-width: none;"><a href="#">Pending Amt.</a></th>
										<th width="90" style="min-width: 0px; max-width: none;"><a href="#">Bad Debts</a></th>
								...
								<tbody>
										...
										<td style="text-align:center">25009</td>
										<td style="text-align:center">45777</td>
										<td style="text-align:center">87555</td>
										
						
						<td width="" style="text-align:center">73049</td>
						
						<td width="" style="text-align:center">12999</a>						</td>
