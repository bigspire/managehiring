...
<input type="hidden" name="end_date" id="end_date" value="<?php echo $end_date;?>"/>	
				...
				<div class="span12">	
						...
						<h3 class="heading" style="margin-bottom:0;border:;clear:left;">Month Wise CV Status (Table View)
							...
							<table class="table table-hover table-bordered table-striped printAreaTable" style="margin: 15px 0px;">
								<thead>
									...
									<tr>
										...
										<th width="100" style="min-width: 0px; max-width: none;"><a href="#">Month</a></th>										
								...
								<tr>
										<td width=""><a target="_blank" href="<?php echo $this->webroot;?>client/view/<?php echo $id;?>/"><?php echo $month;?></td>
...
<li><span class="btn-mini legendBg" style="padding:0px 10px !important"> B </span> &nbsp; Candidate Billed </li>
		...
		<div class="span12">
						<h3 class="heading" style="margin-bottom:0;border:;clear:left;">Month Wise CV Status (Graph View)
