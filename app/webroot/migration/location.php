...
$sql = "select  RID, LocationTitle,ModifiedDate from HCM_LOCATIONS order by RID asc";
...
while($row = mssql_fetch_assoc($result)){
	...
	$save_sql = "insert into location (id, location,created_date)values('$id', '$loc','$modified')";	
