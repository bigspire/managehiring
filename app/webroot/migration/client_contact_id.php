...
$sql = "select  RID, ContactID,[ClientID],ModifiedDate from [HC_CLIENT_CONTACTS_CLIENTID] order by RID asc";
...
while($row = mssql_fetch_assoc($result)){
	...
	$save_sql = "insert into client_contact (id, clients_id,contact_id,modified_date)	values('$id', '$client_id','$contact_id',
		'$modified')";		
