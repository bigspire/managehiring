...
$sql = "select RID, [ResumeID],[Employer],[DesignationText] from [HC_RESUME_EMPLOYER] order by RID asc 
OFFSET 0 ROWS FETCH NEXT 25000 ROWS ONLY";
...
while($row = mssql_fetch_assoc($result)){
	...
	$save_sql = "insert into res_employer (id, resume_id,employer,designation) values('$id', '$res_id','$employer')";	
